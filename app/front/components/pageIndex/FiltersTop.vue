      ...
      <div class="p-options__item p-options__item--view-switcher">
        <div class="p-options__inner">
          ...
          <div class="view-switcher"
            ...
            >
              <svg class="svg-ico-menu-short" xmlns="http://www.w3.org/2000/svg" width="32"
  ...
  export default {
    methods: {
      ...
      onChange(event) {
        ...
        this.$store.commit('choseOrderBy', value)
      },
    },
  }
</script>
